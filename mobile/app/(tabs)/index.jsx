  ...
  const loadData = async () => {
    try {
      ...
      const transformedCategories = apiCategories.map((cat, index) => ({
       ...
       .filter((cat) => cat.name.toLowerCase() !== "beef" && cat.name.toLowerCase() !== "pork");
      ...
      const transformedMeals = randomMeals
        ...
        .filter(
          (meal) =>
      meal !== null &&
      meal.category?.toLowerCase() !== "beef" &&
      meal.category?.toLowerCase() !== "pork" &&
      meal.area?.toLowerCase() === "indian")
